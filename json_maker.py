...
toJSON = [moves,tags,minor_arcana,major_arcana,gm,players,steading]
names = ["moves.json","tags.json","minor_arcana.json","major_arcana.json","gm.json","players.json","steading.json"]
