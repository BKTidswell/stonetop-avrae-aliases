...
moves = [lookup("basicmoves",
                "Basic Moves",
                "View the details of a specific move by specifying it in the command (.e.g. '!st moves knowthings'). When you roll a 6-, mark XP and prepare for the worst (unless the move says otherwise). \n\nAid\nClash\nVolley\nDefend\nDefy Danger\nInterfere\nKnow Things\nLet Fly\nPersuade\nSeek Insight",
                ""),
         lookup("aid",
                "Aid",
         ...
         lookup("specialmoves",
                "Special Moves",
                "View the details of a specific move by specifying it in the command (.e.g. `!st moves deathsdoor`)\n\nBurn Brightly\nDeath's Door\nEnd of Session",
                ""),
         lookup("burnbrightly",
                "Burn Brightly",
                "When you have enough XP to Level Up (6 + twice your current level), you may spend 2 XP after any roll to add +1 to that roll (maximum +1 per roll).",
                ""),
         lookup("deathsdoor",
                "Death's Door",
         ...
         lookup("outfit",
                "Outfit",
                "When you prepare for an expedition, mark as many on your Inventory insert as you wish to carry, either on specific items or in 'undefined.' Mark up to 3 \u25c7 for a light load (quick and quiet), 4-6 \u25c7 for a normal load, or 7-9 \u25c7 for heavy load (noisy, loud, slow, quick to tire). Also, mark a number of \u20de in the Small items section equal to 4+Prosperity (again, on specific items or on Undefined). \nYou can select...\n \uaa5c Items printed on the Inventory insert\n \uaa5c Other common, mundane items\n \uaa5c Any of your personal possessions\n \uaa5c Special items for which you Trade & Barter\n\nTell the GM what you're bringing, and answer their questions about your gear and where you got it.",
                ""),
         lookup("requisition",
                "Requisition",
                "When you borrow some of the steading's assets for an expedition (like the horses or a plow), roll +Fortunes: on a 10+, go ahead, but bring it back safely; on a 7-9, you'll need to do some convincing; on a 6-, don't mark XP-you can take the asset with you if you want, but if you do, reduce Fortunes by 1.",
                ""),
         lookup("havewhatyouneed",
                "Have What You Need",
         ...
         lookup("recover",
                "Recover",
                "When you take time to catch your breath and tend to what ails you, expend 1 use of supplies and regain HP equal to 4+Prosperity. You can't gain this benefit again until you take more damage. When you tend to a debility or a problematic wound, say how. The GM will either say that it's taken care of or tell you what else is required to do so.",
                ""),
         lookup("forage",
                "Forage",
         ...
         lookup("struggleasone",
                ...
                ""),
         lookup("returntriumphant",
                "Return Triumphant",
                "When you return home in triumph, having saved your fellows, put down the threat, seized an opportunity, etc., increase the steading's Fortunes by 1 (to a max of +3).",
                ""),
         ...
         lookup("homefront",
                "Homefront",
                "View the details of a specific move by specifying it in the command (.e.g. `!st moves muster`)\n\nBolster\nDeploy\nLevel Up\nMake a Plan\nMeet with Disaster\nMuster\nPull Together\nConvalesce\nSeasons Change (Spring, Summer, Autumn & Winter)\nSeasonal Gains\nTrader & Barter",
                ""),
         lookup("bolster",
                "Bolster",
                "When you spend downtime in study, meditation, or hard practice, hold Preparation according to the amount of downtime spent:\n \uaa5cA week or so: 1 Preparation\n \uaa5cA month or so: 2 Preparation\n \uaa5cThe better part of a season: 3 Preparation\n\nWhen you make any roll to which your efforts might apply, you may spend 1 Preparation to add +1 to that roll, after it is made (maximum +1 per roll).",
                ""),
         lookup("deploy",
                "Deploy",
                "When you send a steading's people into danger or rally them against an attack, roll +Defenses: on a 10+, it goes as well as can be expected; on a 7-9, it works but someone chooses 1 from the list below. If the stead- ing is acting from a position of strength, you choose. Otherwise, the GM chooses.\n \uaa5cIt's less effective than you expected\n \uaa5cThere are a number of injuries, some serious; take disadvantage on your next Defenses roll\n \uaa5cThe GM picks a named NPC involved in the action; they die",
                ""),
         lookup("levelup",
                "Level Up",
                "When you have a week or more of downtime and XP equal to (or greater than) 6 + twice your current level, you can reflect on your experiences and hone your skills. Resolve the following steps:\n1) Subtract 6 + twice your current level from your XP.\n2) Increase your level by 1.\n3) Choose a new move from your class playbook, or an insert class that you've unlocked.\n4) If you are the Blessed (or have a sacred pouch) and your new level is even, increase your max Stock by 1.\n5) If you are the Lightbearer (or have Invoke the Sun God) and your new level is even, choose a new invocation.\n6) Review your Drive and your Look on the front of your playbook. If anything no longer applies, change it. Feel free to make up new options.",
                ""),
         lookup("makeaplan",
                "Make a Plan",
                "When you wish to accomplish some project but aren't sure how to go about it, tell the GM what you hope to achieve. They'll say what's required. If you aren't sure how to accomplish one of the requirements, ask the GM and they'll tell you what's required for that.",
                ""),
         lookup("meetwithdisaster",
                "Meet with Disaster",
                "When calamity befalls a steading or panic spreads, reduce the steading's Fortunes by at least 1, to a minimum of -3. Other stats might be immediately affected, at the GM's discretion.",
                ""),
         lookup("muster",
                "Muster",
                "When you press every able body into the defense of a steading, reduce Fortunes by 1 and roll +Population: on a 7+, the steading is alert and ready for action, increasing Defenses by 1 for as long as the muster holds; on a 10+, also pick 2; on a 7-9, also pick 1.\n \uaa5cEveryone's willing to pitch in; don't reduce the town's Fortunes after all\n \uaa5cThe muster holds together as long as the threat lasts, even without your presence\n \uaa5c1 or 2 individuals show real potential; ask the GM who and how",
                ""),
         lookup("pulltogether",
                "Pull Together",
                "When you set a community to work on improvements, to secure new resources, or to make major repairs, spend whatever the GM says is required (time, coin, Surplus, etc.) and roll +Population: on a 10+, the job gets done; on a 7-9, pick 1:\n \uaa5cIt gets done, but other work doesn't; reduce Fortunes by 1\n \uaa5cIt gets done, but the work is shoddy, crude\n \uaa5cThere's an unforeseen cost or requirement; address it and the job gets done",
                ""),
         lookup("convalesce",
                "Convalesce",
         ...
         lookup("barkskin",
                "\u20de Barkskin",
                "When you are touching the ground, you have 2 armor. When you mark another with 1 Stock, they gain this benefit so long as the mark remains.",
                ""),
         lookup("bigmagic",
                "\u20de\u20de Big Magic",
         ...
         lookup("improvedstat",
                ...
                ""),
         lookup("intothelionsden",
                "\u20de Into the Lion's Den",
                "When you approach a beast calmly and show no fear, it will not harm you-though it may well threaten you and test your nerve. When you lay your hand gently upon a beast, it will calm to your touch.",
                ""),
         lookup("lightningrod",
                "\u20de Lightning Rod",
                "When you Defend while touching the ground, you can spend 1 Readiness to intercept a nearby magical attack and redirect it harmlessly into the ground.",
                ""),
         lookup("ritesoftheland",
                "\u20de Rites of the Land",
                "When Seasons Change and you oversee the sacred rites, you can sacrifice 2 Surplus to increase the steading's Fortunes by 1 (max +3). If you sacrifice something (or someone) much-loved and greatly valued, you can redo a roll from Seasons Change, with your choice of advantage or disdvantage.",
                ""),
         lookup("spirittongue",
                "\u20de Spirit Tongue",
         ...
         lookup("sharedsouls",
                ...
                ""),
         lookup("suckthepoisonout",
                "\u20de Suck the Poison Out",
         ...
         lookup("superiorstat",
                ...
                ""),
         lookup("voiceoftheearthmother",
                "\u20de Voice of the Earth Mother",
         ...
         lookup("fox",
                "Fox",
                "The Fox starts with Ambush OR Skill at Arms; danger Sense OR Perceptive; and 1 of their choice. View the details of a specific move by specifying it in the command (.e.g. `!st moves catlike`)\n\nAny Level Moves:\nAll in the Wrist\nAmbush\nBurgle\nCatlike\nDanger Sense\nFree Running\nImproved Stat\nLaugh at Danger\nLight Fingers\nPerceptive\nRapier Wit\nSkill at Arms\nParry & Riposte\nSilver Tongued\nUnder Your Skin\n\nLevel 2+ Moves:\nDabbler\n\nLevel 6+ Moves:\nBatle Dancer\nCheap Shot\nEye on the Door\nPants on Fire\nSecond Intent\nSlippery\nSuperior Stat",
                ""),
         lookup("allinthewrist",
                "\u20de All in the Wrist",
                "Any knife or dagger gets the thrown tag in your hands. Also, you keep a number of iron throwing blades (near) on you; they don't take up space in your inventory. Your ammo replenishes whenever you Outfit.",
                ""),
         lookup("ambush",
                "\u20de Ambush",
         ...
         lookup("dangersense",
                "\u20de Danger Sense",
                "You can always as the GM, 'Is there a trap here?' If they say 'yes,' roll +INT: on a 10+, ask the GM both of the questions below; on a 7-9, ask 1; either way, gain advantage on your next roll to act on the answer(s).\n \uaa5cWhat will trigger the ambush or trap?\n \uaa5cWhat will happen once it's triggered?\n\nOn a 6-, don't mark XP but nothing bad happens just yet.",
                ""),
         lookup("freerunning",
                "\u20de Free Running",
         ...
         lookup("irresistible",
                ...
                ""),
         lookup("laughatdanger",
                "\u20de Laugh at Danger",
                "When you make a joke in the face of adversity, you may roll +CHA in place of +CON.",
                ""),
         lookup("lightfingers",
                "\u20de Light Fingers",
         ...
         lookup("skillatarms",
                "\u20de Skill at Arms",
                "When you wield a spear, sword, or staff, it has the precise tag (you can Clash with DEX).",
                ""),
         lookup("parryandriposte",
                "\u20de Parry & Riposte",
         ...
         lookup("heavy",
                "Heavy",
                "The Heavy starts with Dangerous, Hard to Kill, and either Armored OR Uncanny Reflexes.\n\nView the details of a specific move by specifying it in the command (.e.g. `!st moves terroronthefield`)\n\nAny Level Moves:\nArmored\nBattle Joy\nBerserker\nCarved out of Wood\nDangerous\nFormidable\nFrosty\nGaurdian\nImproved Stat\nIntimidating\nHard to Kill\nUnstoppable\nPayback\nRelentless\nSituational Awareness\nUncanny Reflexes\nUnfettered\nTerror on the Field\n\nLevel 2+ Moves:\nMusclebound\nSeasoned Warrior\n\nLevel 6+ Moves:\nBringer of Ruin\nCut of Granite\nMighty Threws\nNemesis\nSteadfast Guardian\nStone Cold\nSuperior Stat",
                ""),
         lookup("armored",
                "\u20de Armored",
                "When you wear armor or carry a shield, mark only \u25c7 for each (instead of \u25c7\u25c7), and ignore the clumsy tag (you don't suffer disadvantage for wearing it). If you take this move at the start of play, add an \u25c7 iron hauberk, \u25c7 bronze cuirass, or \u25c7 scale coat to your inventory (all are 2 armor, warm, clumsy).",
                ""),
         lookup("battlejoy",
                "\u20de Battle Joy",
         ...
         lookup("relentless",
                ...
                ""),
         lookup("seasonedwarrior",
                "\u20de\u20de\u20de Seasoned Warrior",
                ...
                ""),
         lookup("situationalawareness",
                "\u20de Situational Awareness",
         ...
         lookup("unfettered",
                ...
                ""),
         lookup("terroronthefield",
                "\u20de Terror on the Field",
         ...
         lookup("nemesis",
                ...
                ""),
         lookup("steadfastguardian",
                "\u20de Steadfast Guardian",
         ...
         lookup("judge",
                "Judge",
                "The Judge starts with Censure, Chronicler of Stonetop, and 2 more of their choice.\n\nView the details of a specific move by specifying it in the command (.e.g. `!st moves aegisoffaith`)\n\nAny Level Moves:\nAegis of Faith\nArmored\nBear Witness\nBreak Bread\nBulwark\nCensure\nChronicler of Stonetop\nFor the Greater Good\nHound of Aratis\nLike a Dog with a Bone\nImproved Stat\nKnowledge is Power\nMany Hands Make Light Work\nA Bundle of Sticks Unbroken\nThe Hammer and the Book\nTruth of Consequences\nBinding Arbitration\nVision Unclouded\nWell-Read\n\nLevel 2+ Moves:\nCastigate\n\nLevel 6+ Moves:\nA Mighty Rampart\nArmistice\nCondemn\nProclamation\nMirrorshield\nSuperior Stat\nThe Tower Eternal",
                ""),
         lookup("aegisoffaith",
                "\u20de Aegis of Faith",
                "When you bear a shield, it can turn away spells, magical effects, and insubstantial attacks as if they were physical blows.",
                ""),
         lookup("armored",
                "\u20de Armored",
                "When you wear armor or carry a shield, mark only \u25c7 for each (instead of \u25c7\u25c7), and ignore the clumsy tag (you don't suffer disadvantage for wearing it). If you take this move at the start of play, add an \u25c7 iron hauberk, \u25c7 bronze cuirass, or \u25c7 scale coat to your inventory (all are 2 armor, warm, clumsy).",
         ...
         lookup("bearwitness",
                "\u20de Bear Witness",
                "When you speak the truth with conviction and can- dor, none can doubt you. They might deny what you say, but in their hearts they recognize the truth.",
                ""),
         lookup("breakbread",
                "\u20de Break Bread",
                "When you share a proper meal with someone and each of you eats their fill, each of you recovers 1d8 (extra) hit points.",
                ""),
         lookup("bulwark",
                "\u20de Bulwark",
         ...
         lookup("chroniclerofstonetop",
                ...
                ""),
         lookup("forthegreatergood",
                "\u20de For the Greater Good",
                "When you Order Followers in defense of civilization, treat a result of 6- as a 7-9. In addition, your followers always accept 'thwarting a threat to civilization' as payment of their cost.",
                ""),
         lookup("houndofaratis",
                "\u20de Hound of Aratis",
                "When you Seek Insight, you can always ask 'What here is tainted by chaos?' for free, even on a 6-.",
                ""),
         lookup("likeadogwithabone",
                "\u20de Like a Dog with a Bone",
         ...
         lookup("manyhandsmakelightwork",
                ...
                ""),
         lookup("abundleofsticksunbroken",
                "\u20de A Bundle of Sticks Unbroken",
                "(Requires Many Hands Make Light Work)\nWhen you Struggle as One, you and one ally of your choice have advantage.",
                ""),
         lookup("thehammerandthebook",
                "\u20de The Hammer and the Book",
                ...
                ""),
         lookup("truthandconsequences",
                "\u20de Truth and Consequences",
                "When you look into someone's eyes and gaze upon their soul, roll +WIS: on a 10+, hold 3 Insight; on a 7-9, hold 2; on a 6-, hold 1 anyway, but you can never use this move on them again.\n\nWhile in their presence, spend 1 Insight to ask their player 1 of the following and get an honest answer:\n \uaa5cAre you lying?\n \uaa5cAre you hiding something from me?\n\nIf they answer 'yes,' gain advantage on your next move against them.",
                ""),
         lookup("bindingarbitration",
                "\u20de Binding Arbitration",
         ...
         lookup("superiorstat",
                ...
                "(Requires level 6+)\nIncrease one of your stats by +1 (to a max of +3).",
                ""),
         lookup("thetowereternal",
                "\u20de The Towere Eternal",
         ...
         lookup("lightbearer",
                "Lightbearer",
                "The Lightbearer starts with Consecrated Flame and Invoke the Sun God, and 1 of their choice.\n\nView the details of a specific move by specifying it in the command (.e.g. `!st moves firewithin`)\n\nAny Level Moves:\nA Candle Against the Dark\nLuminous Shield\nAll is Illuminated\nAnd Behold a Pale Horse\nConsecrated Flame\nFire Within\nGuiding Light\nHelior's Unblinking Eye\nImproved Stat\nInvoke the Sun God\nKeep the Home-Fires Burning\nLmaplighter\nPiety\nPurifying Flames\nRadiant Countenance\nRise Like the Sun\nSpring's First Thaw\n\nLevel 6+ Moves:\nBurn Twice as Bright\nEmpowered Invocations\nGlorious Servant\nHungry Flames\nLight, More Light\nSuperior Stat\nWielder of the White Flame",
                ""),
         lookup("acandleagainstthedark",
                "\u20de A Candle Against the Dark",
                "When you wield a holy light but go otherwise un- armed, you have 2 Armor.",
                ""),
         lookup("luminousshield",
                "\u20de Luminous Shield",
                ...
                ""),
         lookup("allisilluminated",
                "\u20de All is Illuminated",
                ...
                ""),
         lookup("andbeholdapalehorse",
                "\u20de And Behold a Pale Horse",
         ...
         lookup("guidinglight",
                ...
                ""),
         lookup("heliorsunblinkingeye",
                "\u20de Helior's Unblinking Eye",
                "When you stare into the sun long enough to lose your vision, name a person or place that you know and roll +WIS: on a 10+, you briefly glimpse your sub- ject as if from a great height, and choose 2 from the list below; on a 7-9, you briefly glimpse your subject as if from a great height, and choose 1:\n \uaa5cThe glimpse lasts as long as you wish\n \uaa5cYour point of view shifts to very close range\n \uaa5cYou recover your vision quickly",
                ""),
         lookup("improvedstat",
                "\u20de\u20de\u20de Improved Stat",
                "Each time you take this move, increase one of your stats by 1 (to a max of +2)",
                ""),
         lookup("invokethesungod",
                "\u20de Invoke the Sun God",
                ...
                ""),
         lookup("keepthehomefiresburning",
                "\u20de Keep the Home-Fires Burning",
         ...
         lookup("lamplighter",
                "\u20de Lamplighter",
                "When you whisper to a flammable object (torch, wick, kindling, etc.), it ignites in moments.",
                ""),
         lookup("piety",
                "\u20de Piety",
                ...
                ""),
         lookup("purifyingflames",
                "\u20de Purifying Flames",
                "When you wield a holy light against creatures of darkness, you may roll +WIS to Clash. When you do so, your range is that of your light source, and your damage is d10 (ignores armor).",
                ""),
         lookup("radiantcountance",
                "\u20de Radiant Countance",
                "When you give your fond attention and affection to your followers, they accept it as payment regardless of their usual Cost and you gain advantage on your next roll to Order Followers.",
                ""),
         lookup("riselikethesun",
                "\u20de Rise Like the Sun",
                ...
                ""),
         lookup("springsfirstthaw",
                "\u20de Spring's First Thaw",
                ...
                ""),
         lookup("burnstwiceasbright",
                "\u20de Burns Twice as Bright",
                ...
                ""),
         lookup("enpoweredinvocations",
                "\u20de Enpowered Invocations",
         ...
         lookup("superiorstat",
                ...
                "(Requires level 6+)\nIncrease one of your stats by +1 (to a max of +3).",
                ""),
         lookup("wielderofthewhiteflame",
                "\u20de Wielder of the White Flame",
         ...
         lookup("veterancrew",
                ...
                ""),
         lookup("frontlineleader",
                "\u20de Front Line Leader",
                "You have advantage to Order Followers while fighting. When at least one ally Aids your attack, deal +1d4 damage (+1 for each extra attacker).",
                ""),
         lookup("improvedstat",
                "\u20de\u20de\u20de Improved Stat",
                "Each time you take this move, increase one of your stats by 1 (to a max of +2)",
         ...
         lookup("setupstrike",
                "\u20de Set-Up Strike",
                "When you call an ally's attention to an attack you are about to make, that ally's next attack against the same target does +1d4 damage.",
                ""),
         lookup("shakeitoff",
                "\u20de Shake it Off",
         ...
         lookup("shieldwall",
                ...
                ""),
         lookup("sirpermissiontodiesir",
                "\u20de Sir, Permission to Die, Sir",
                "When one of your followers is at Death's Door, pick 1:\n\n\uaa5c They roll +Loyalty (instead of +nothing)\n\uaa5c  You let them go; they die and you mark XP.",
                ""),
         lookup("speaksoftly",
                "\u20de Speak Softly",
         ...
         lookup("stentorian",
                "\u20de Stentorian   \u25ef\u25ef",
                "When you raise your voice, it carries far and cuts through even the din of battle.\n\nWhen you go into battle, hold 2 Command. You can spend 1 Command to shout an order or warning to an ally; they gain advantage on their next roll to do as you say.",
                ""),
         lookup("takethemeasure",
                "\u20de Take the Measure",
                "When you size someone up, ask their player one of the questions below a get an honest answer. If they fear or respect you (their call), you can ask another question. You can't use this move on them again until your relationship significantly changes.\n\n\uaa5c Can I trust them (to ______ )?\n\uaa5c What do they intend to do?\n\uaa5c How are they most useful/dangerous? What weakness of theirs can I exploit?",
                ""),
         lookup("wehappyfew",
                "\u20de We Happy Few",
         ...
         lookup("battlefieldgrace",
                ...
                ""),
         lookup("heroestothelast",
                "\u20de\u20de Heroes to the Last",
         ...
         lookup("noblemien",
                ...
                ""),
         lookup("peacethroughstrength",
                "\u20de Peace Through Strength",
         ...
         lookup("ranger",
                "Ranger",
                "The Ranger starts with Home on the Range, any Background Moves, plus one of their choice.\n\nView the details of a specific move by specifying it in the command (.e.g. `!st moves readtheland`)\n\nAny Level Moves:\nA Safe Place\nAnimal Companion\nMagnificant Specimen\nBig Game Hunter\nBlot out the Sun\nCall the Shot\nExpert Tracker\nHome on the Range\nImproved Stat\nMental Map\nNaturalist\nOn the Hoof\nPack Horse\nPredator\nSense the Unnatural\nStalker\nWild Speech\nAlpha\n\nLevel 2+ Moves:\nWorldly\n\nLevel 6+ Moves:\nBeast of Legend\nConstant Vigilance\nGiant Slayer\nMaster Tracker\nSuperior Stat\nTrailblazer\nWalk it Off\nWarden of the Wild",
                ""),
         lookup("asafeplace",
                "\u20de A Safe Place   \u25ef\u25ef",
         ...
         lookup("onthehoof",
                "\u20de On the Hoof",
                "When you travel through the wilderness, you can procure 1d6 uses of \u25c7 provisions each day (roll with disadvantage in winter or barren terrain). Each use of provisions can substitute for 1 supplies when you Make Camp.",
                ""),
         lookup("packhorse",
                "\u20de Pack Horse",
         ...
         lookup("predator",
                ...
                ""),
         lookup("sensetheunnatural",
                "\u20de Sense the Unnatural",
                "When you Seek Insight, you can always ask, 'What here is a perversion of the natural order?' for free, even on a 6-.",
                ""),
         lookup("stalker",
                "\u20de Stalker",
         ...
         lookup("wildspeech",
                "\u20de Wild Speech",
                "The grunts, barks, chirps, and calls of natural creatures are as a language to you. You can understand the intentions of and communicate basic ideas with any beast.",
                ""),
         lookup("alpha",
                "\u20de Alpha",
                "(Requires Wild Speech or Spirit Tongue) When you assert your dominance over a beast or spirit of the wild, roll +WIS: on a 7+, it must choose 1 from the list below; on a 10+, you also gain advantage on your next roll against it.\n\n\uaa5c Fight you for dominance\n\uaa5c Slink away or flee, then avoid you\n\uaa5c Accept your authority, at least for now",
                ""),
         lookup("worldly",
                "\u20de\u20de Worldly",
         ...
         lookup("countermeasures",
                ...
                ""),
         lookup("everythingbleeds",
                "\u20de Everything Bleeds",
                "When you exploit an unnatural foe's specific weak- ness or vulnerability, deal +1d6 damage.",
                ""),
         lookup("Everything Burns",
                "\u20de When you inspect a work of artifice or magic for a fatal flaw, roll +INT: on a 7+, the GM will reveal the best way to destroy/sabotage it; on a 10+, you or an ally also gain advantage to act on the info.",
                "",
                ""),
         lookup("improvedstat",
                "\u20de\u20de\u20de Improved Stat",
                "Each time you take this move, increase one of your stats by 1 (to a max of +2)",
                ""),
         lookup("initiateofthesecretarts",
                "\u20de\u20de\u20de Initiate of the Secret Arts",
         ...
         lookup("safetyfirst",
                "\u20de Safety First   \u25ef\u25ef",
                "When you spend an hour or so preparing your mystical defenses, hold 2 Protection. When you are affected by harmful magic, spend 1 Protection to halve the damage or effect.",
                ""),
         lookup("sageadvice",
                "\u20de Sage Advice",
                "When you someone asks you for guidance, they get advantage on their next roll to follow your advice.",
                ""),
         lookup("wellversed",
                "\u20de\u20de\u20de Well Versed",
         ...
         lookup("overchannel",
                ...
                ""),
         lookup("proofagainstdetection",
                "\u20de Proof Against Detection",
         ...
         lookup("angerisagift",
                ...
                ""),
         lookup("speaktruthtopower",
                "\u20de Speak Truth to Power",
         ...
         lookup("igetknockeddown",
                ...
                ""),
         lookup("butigetupagain",
                "\u20de But I Get Up Again",
         ...
         lookup("nevergonnakeepmedown",
                ...
                ""),
         lookup("potentialforgreatness",
                "\u20de Potential for Greatness",
         ...
         lookup("resourceful",
                ...
                ""),
         lookup("somethingtoremembermeby",
                "\u20de Something to Remember Me By",
         ...
         lookup("versatile",
                ...
                ""),
         lookup("aforcetobereckonedwith",
                "\u20de A Force to be Reckoned With",
         ...
         lookup("bigdamnhero",
                "\u20de Big Damn Hero",
                "(Requires level 6+; replaces In Over Your Head) When you first leap into danger to protect someone, don't roll to Defend. Instead, treat as though you rolled a 10+.\n\nWhen you Defend, you can spend 1 Readiness to lock eyes with an attacker; they have disadvantage on damage rolls against you and your ward for the rest of the fight.\n\nWhen you take this move cross off 'Would-Be' on your character title",
                ""),
         lookup("herosuperiorstat",
                "\u20de Hero Superior Stat",
         ...
         lookup("undaunted",
                ...
                ""),
         lookup("voiceofexperience",
                "\u20de Voice of Experience",
         ...
         lookup("revenant",
                "Revenant",
                "View the details of a specific move by specifying it in the command (.e.g. `!st moves unliving`)\n\nUnliving\nUndying\nImplacable",
                ""),
         lookup("unliving",
                "\u20de Unliving",
         ...
         lookup("implacable",
                "\u20de Implacable",
                "When you push the limits of your undead body, lose 1d4 HP and choose 1:\n \uaa5cPerform a feat of inhuman strength\n \uaa5cAct with uncanny speed and grace\n \uaa5cRefuse to be moved, held back, or knocked off course",
                ""),



         lookup("ghost",
                "View the details of a specific move by specifying it in the command (.e.g. `!st moves disembodied`)\n\nUnliving\nDisembodied\nTethered",
                "",
                ""),
         lookup("unliving",
                "\u20de Unliving",
         ...
         lookup("thrall",
                 "View the details of a specific move by specifying it in the command (.e.g. `!st moves favor`)\n\nFavor\nImpulse\nDark Succor\nUnholy Vessel",
                "",
                ""),
         lookup("favor",
                "\u20de Favor   \u25ef\u25ef\u25ef",
